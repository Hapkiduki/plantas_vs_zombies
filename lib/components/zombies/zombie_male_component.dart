...
import 'package:plantas_vs_zombies/utils/create_animation_by_limit.dart';

import 'zombie_component.dart';

class ZombieMaleComponent extends ZombieComponent {
  ZombieMaleComponent({required super.position}) {
  ...
  FutureOr<void> onLoad() async {
    ...
    body = RectangleHitbox(
        ...
        position: Vector2(0, alignZombie.toDouble()))
