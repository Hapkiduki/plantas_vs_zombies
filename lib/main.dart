...
import 'components/plants/cactus_component.dart';
import 'components/plants/peashooter_component.dart';
import 'components/plants/plant_component.dart';
import 'components/plants/sun_component.dart';
import 'components/zombies/zombie_component.dart';
import 'components/zombies/zombie_female_component.dart';
import 'components/zombies/zombie_male_component.dart';
import 'helpers/enemies/movements.dart';
import 'map/background_component.dart';
import 'map/tile_map_component.dart';
import 'overlay/option_overlay.dart';
import 'overlay/plant_overlay.dart';
import 'overlay/sun_overlay.dart';
          ...
          world.add(
            ZombieMaleComponent(
              position: Vector2(
                ...
                enemiesMap1[zombieI].position - alignZombie * 1.0,
              ),
            ),
          );
        } else {
          world.add(
            ZombieFemaleComponent(
              position: Vector2(
                background!.tiledMap.size.x,
                enemiesMap1[zombieI].position - alignZombie * 1.0,
              ),
